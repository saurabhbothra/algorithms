...
public class FactorialTrailingZeros {
	...
	public static void main(String[] args) {
		...
		System.out.println("(Second Solution) Numer of trailing zeros in the factorial is " + getTrailingZerosFactorialCount(30));
		System.out.println("(Efficient Solution) Numer of trailing zeros in the factorial is " + efficientTrailingZerosFactorial(30));
		System.out.println("(Efficient Solution 2) Numer of trailing zeros in the factorial is " + efficient2TrailingZerosFactorial(30));
